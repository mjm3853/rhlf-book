...
class GridWorldEnv(gym.Env):
    ...
    def __init__(self, render_mode=None, size=4):
        ...
        # Define the target location(s) in the grid
        self._target_location = np.array([0, size*size - 1], dtype=int)
        self.nS = self.observation_space.n  # Total number of states
        self.nA = self.action_space.n  # Total number of actions
        self.shape = (self.size, self.size)  # Shape of the grid
    ...
    def _get_info(self):
        # Calculate the Manhattan distance from the agent to the nearest target
    ...
    def _terminated(self):
        # Check if the agent has reached any of the target locations
    ...
    def step(self, action):
        ...
        # Reward is 0 if the agent is at the target location, otherwise -1
